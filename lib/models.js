...
module.exports = {
    __init: function (db, models, next) {
        ...
        module.exports.map_fields = models.map_fields = db.define('map_fields', {
            id: {type: 'serial', key: true},
            region_id: {type: 'integer', defaultValue: 0},
            x: {type: 'integer', defaultValue: 0},
            y: {type: 'integer', defaultValue: 0}
        },{autoFetch: true});
        module.exports.fields_resources = models.fields_resources = models.map_fields.extendsTo('resources', {
        ...
        module.exports.resources = models.resources = db.define('map_fields_resources', {
